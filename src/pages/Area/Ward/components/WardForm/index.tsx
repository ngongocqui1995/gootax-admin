...
const WardForm: React.FC = () => {
    ...
    switch (ward.WardForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Area.Ward.WardForm.Create.title',
          defaultMessage: 'Thêm mới phường/xã',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Area.Ward.WardForm.Update.title',
  ...
  const renderSubmitText = () => {
    switch (ward.WardForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Area.Ward.WardForm.Create.submitText',
          defaultMessage: 'Tạo mới',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Area.Ward.WardForm.Update.submitText',
          ...
          submitter={{
            ...
            searchConfig: {
              ...
              resetText: intl.formatMessage({
                id: 'pages.Area.Ward.WardForm.resetText',
