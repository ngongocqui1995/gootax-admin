...
const DistrictForm: React.FC = () => {
    ...
    switch (district.DistrictForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Area.District.DistrictForm.Create.title',
          defaultMessage: 'Thêm mới quận/huyện',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Area.District.DistrictForm.Update.title',
  ...
  const renderSubmitText = () => {
    switch (district.DistrictForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Area.District.DistrictForm.Create.submitText',
          defaultMessage: 'Tạo mới',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Area.District.DistrictForm.Update.submitText',
          ...
          submitter={{
            ...
            searchConfig: {
              ...
              resetText: intl.formatMessage({
                id: 'pages.Area.District.DistrictForm.resetText',
