...
const ProvinceForm: React.FC = () => {
    ...
    switch (province.ProvinceForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Admin.Province.ProvinceForm.Create.title',
          defaultMessage: 'Thêm mới tỉnh/thành phố',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Admin.Province.ProvinceForm.Update.title',
  ...
  const renderSubmitText = () => {
    switch (province.ProvinceForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Admin.Province.ProvinceForm.Create.submitText',
          defaultMessage: 'Tạo mới',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Admin.Province.ProvinceForm.Update.submitText',
          ...
          submitter={{
            ...
            searchConfig: {
              ...
              resetText: intl.formatMessage({
                id: 'pages.Admin.Province.ProvinceForm.resetText',
