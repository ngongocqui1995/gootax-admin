import { TypeCarItem } from '@/pages/Admin/TypeCar/data';
import { TypeCarModalState } from '@/pages/Admin/TypeCar/model';
import { changeStatusTypeCar } from '@/pages/Admin/TypeCar/service';
