...
const TypeCarForm: React.FC = () => {
    ...
    switch (type_car.TypeCarForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Admin.TypeCar.TypeCarForm.Create.title',
          defaultMessage: 'Thêm mới tài xế',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Admin.TypeCar.TypeCarForm.Update.title',
  ...
  const renderSubmitText = () => {
    switch (type_car.TypeCarForm?.type) {
      ...
      case TYPE_FORM.COPY:
        return intl.formatMessage({
          id: 'pages.Admin.TypeCar.TypeCarForm.Create.submitText',
          defaultMessage: 'Tạo mới',
        });
      case TYPE_FORM.UPDATE:
        return intl.formatMessage({
          id: 'pages.Admin.TypeCar.TypeCarForm.Update.submitText',
          ...
          submitter={{
            ...
            searchConfig: {
              ...
              resetText: intl.formatMessage({
                id: 'pages.Admin.TypeCar.TypeCarForm.resetText',
